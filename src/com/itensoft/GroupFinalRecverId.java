...
/**
 * GroupFinalRecverId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class GroupFinalRecverId implements java.io.Serializable {
	...
	/** default constructor */
	public GroupFinalRecverId() {
	}

	/** full constructor */
	public GroupFinalRecverId(Integer groupCode, String certId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GroupFinalRecverId))
			return false;
		GroupFinalRecverId castOther = (GroupFinalRecverId) other;
