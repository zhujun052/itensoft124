...
/**
 * GroupFinalManagerId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class GroupFinalManagerId implements java.io.Serializable
{
	...
	/** default constructor */
	public GroupFinalManagerId()
	{
	}

	/** full constructor */
	public GroupFinalManagerId(Integer groupCode, String virtualManagerName)
	{
	...
	public boolean equals(Object other)
	{
		...
		if ((other == null))
			return false;
		if (!(other instanceof GroupFinalManagerId))
			return false;
		GroupFinalManagerId castOther = (GroupFinalManagerId) other;
