...
/**
 * GroupIdentityId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class GroupIdentityId implements java.io.Serializable {
	...
	/** default constructor */
	public GroupIdentityId() {
	}

	/** full constructor */
	public GroupIdentityId(Integer groupCode, String certId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GroupIdentityId))
			return false;
		GroupIdentityId castOther = (GroupIdentityId) other;
