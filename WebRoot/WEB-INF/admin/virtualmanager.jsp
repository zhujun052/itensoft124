...
<div class="container">
<div class="hidden">
<div id="virtualmanager_add" style="width:500px;height:385px" iconCls="icon-save" class="easyui-window" <%=win_topbar %> title="审批员添加">
			...
			<div region="south" class="btnbar" border="false">
				<a class="easyui-linkbutton" iconCls="icon-ok"
					...
					href="javascript:void(0)" onclick="closeWin('virtualmanager_add')">取消</a>
			</div>
		</div>
</div>
